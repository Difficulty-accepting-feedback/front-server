...
import {getGroups, GroupResponse, Category, SkillTagLabel, PersonalityTagLabel} from '@/lib/study-api';
            ...
            <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                    <h1 className="text-4xl md:text-4xl font-bold mb-6 leading-tight text-gray-800">
                        같은 목표를 가진 동료들과 지식을 나누고
                    </h1>
                    <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed text-gray-600">
                        더 효과적인 학습을 향해 나아가세요!
                        <span className="ml-1 font-semibold text-gray-900"> 혼자서는 어려운 것도 함께라면 가능해요. </span>
                    </p>
                    ...
                    <div className="relative max-w-4xl mx-auto mb-8">
                        ...
                        <Input
                            ...
                            placeholder="스터디 이름, 소개글, 스터디장의 닉네임으로 검색해 보세요"
                    ...
                    {loading ? (
                        ...
                        <>
                            {filteredGroups.map((group) => (
                                <Card
                                    onClick={() => router.push(`/study/${group.groupId}`)}
                                    role="link"
                                    tabIndex={0}
                                    onKeyDown={(e) => {
