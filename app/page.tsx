...
export default function HomePage() {
  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-green-100">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:flex items-center space-x-8">
                <Link href="#features" className="text-emerald-700 hover:text-emerald-900 transition-colors font-medium">
                  기능
                </Link>
                <Link href="#categories" className="text-emerald-700 hover:text-emerald-900 transition-colors font-medium">
                  카테고리
                </Link>
                <Link href="#testimonials" className="text-emerald-700 hover:text-emerald-900 transition-colors font-medium">
                  후기
                </Link>
                <Link href="/about" className="text-emerald-700 hover:text-emerald-900 transition-colors font-medium">
                  소개
                </Link>
          ...
          {isMenuOpen && (
              <div className="md:hidden bg-white/95 backdrop-blur-md border-t border-emerald-100">
                <div className="px-2 pt-2 pb-3 space-y-1">
                  <Link href="#features" className="block px-3 py-2 text-emerald-700 hover:text-emerald-900 hover:bg-emerald-50 rounded-md">
                    기능
                  </Link>
                  <Link href="#categories" className="block px-3 py-2 text-emerald-700 hover:text-emerald-900 hover:bg-emerald-50 rounded-md">
                    카테고리
                  </Link>
                  <Link href="#testimonials" className="block px-3 py-2 text-emerald-700 hover:text-emerald-900 hover:bg-emerald-50 rounded-md">
                    후기
                  </Link>
                  <Link href="/about" className="block px-3 py-2 text-emerald-700 hover:text-emerald-900 hover:bg-emerald-50 rounded-md">
                    소개
                  </Link>
                  <div className="flex flex-col space-y-2 pt-4 border-t border-emerald-100">
                    <Button variant="ghost" size="sm" className="text-emerald-700 hover:text-emerald-900 justify-start">
                      로그인
                    </Button>
                    <Button size="sm" className="bg-emerald-600 hover:bg-emerald-700">
                      시작하기
        ...
        {/* Footer */}
        <footer className="bg-emerald-900 text-white py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-emerald-200 mb-4 max-w-md">
                  한 그루의 꿈을 심고 함께 성장하는 커뮤니티 플랫폼
                </p>
                <div className="flex space-x-4">
                  <Globe className="h-6 w-6 text-emerald-300 hover:text-white cursor-pointer" />
                  <Award className="h-6 w-6 text-emerald-300 hover:text-white cursor-pointer" />
                  <Users className="h-6 w-6 text-emerald-300 hover:text-white cursor-pointer" />
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-emerald-200">
                  <li><Link href="#" className="hover:text-white transition-colors">스터디 그룹</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">취미 모임</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">멘토링</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">이벤트</Link></li>
                </ul>
              </div>
            ...
            <div className="border-t border-emerald-800 mt-12 pt-8 text-center text-emerald-300">
              <p>© {new Date().getFullYear()} Grow. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
